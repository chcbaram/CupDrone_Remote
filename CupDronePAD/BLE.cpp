...
/*---------------------------------------------------------------------------
     ...
     RET     : void
---------------------------------------------------------------------------*/
uint8_t BLE::send_cmd( String str, String &strRet, uint32_t TimeOut )
{
	uint32_t tTime;
	char ch;
	uint8_t err_code = BLE_OK;
...
/*---------------------------------------------------------------------------
     ...
     RET     : void
---------------------------------------------------------------------------*/
uint8_t BLE::send_scan( uint32_t TimeOut )
{
	uint8_t err_code = BLE_OK;
	String strRet;
	int Index;
...
/*---------------------------------------------------------------------------
     ...
     RET     : void
---------------------------------------------------------------------------*/
uint8_t BLE::connect( uint8_t ch )
{
	uint8_t err_code = BLE_OK;
	String strRet;
